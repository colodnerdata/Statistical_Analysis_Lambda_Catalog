...
from lambda_catalog.write_sheet_csv_dataset import MILEAGE, load_csv_rows


def test_mileage_completeness_matches_expected_na_rows() -> None:
    flags = calculate_mileage_completeness_flags(DEFAULT_INPUT_CSV)
    headers, rows = load_csv_rows(DEFAULT_INPUT_CSV, MILEAGE)
