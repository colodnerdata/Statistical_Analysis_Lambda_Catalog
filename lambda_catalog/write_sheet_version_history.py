...
_VERSIONS = [
    ...
    },
    {
        ...
        "summary": (
            ...
            "CROSS-VALIDATED FIT sub-block at AG10:AH13: LOOCV RMSE (Unit) "
            "and LOOCV MAE (Unit) in original units (rows 11–12), and a "
            "Smearing Treatment readout (row 13) that names how the smearing "
            ...
            "to fp precision, including under Fixed Effects. The AG8 in-"
            ...
            "Catalog grows from 151 to 155 functions. Model Comparison, "
            "planned at v3.4, is renumbered to v3.5."
        ),
    },
]
