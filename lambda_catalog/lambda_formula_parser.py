...
XML_FUNCTION_PREFIXES = {
    ...
    "BINOM.DIST.RANGE": "_xludf.BINOM.DIST.RANGE",
    "BINOM.INV":        "_xludf.BINOM.INV",
    "CHISQ.DIST":       "_xludf.CHISQ.DIST",
    "CHISQ.DIST.RT":    "_xludf.CHISQ.DIST.RT",
    "CHISQ.INV":        "_xludf.CHISQ.INV",
    "CHISQ.INV.RT":     "_xludf.CHISQ.INV.RT",
    "CHISQ.TEST":       "_xludf.CHISQ.TEST",
    "CONFIDENCE.NORM":  "_xludf.CONFIDENCE.NORM",
    "CONFIDENCE.T":     "_xludf.CONFIDENCE.T",
    "COVARIANCE.P":     "_xludf.COVARIANCE.P",
    "COVARIANCE.S":     "_xludf.COVARIANCE.S",
    "EXPON.DIST":       "_xludf.EXPON.DIST",
    "F.DIST":           "_xludf.F.DIST",
    "F.DIST.RT":        "_xlfn.F.DIST.RT",   # confirmed _xlfn in workbook.xml
    "F.INV":            "_xludf.F.INV",
    "F.INV.RT":         "_xludf.F.INV.RT",
    "F.TEST":           "_xludf.F.TEST",
    "GAMMA.DIST":       "_xludf.GAMMA.DIST",
    "GAMMA.INV":        "_xludf.GAMMA.INV",
    "GAMMALN.PRECISE":  "_xludf.GAMMALN.PRECISE",
    "HYPGEOM.DIST":     "_xludf.HYPGEOM.DIST",
    "LOGNORM.DIST":     "_xludf.LOGNORM.DIST",
    "LOGNORM.INV":      "_xludf.LOGNORM.INV",
    "MODE.MULT":        "_xludf.MODE.MULT",
    "MODE.SNGL":        "_xludf.MODE.SNGL",
    "NEGBINOM.DIST":    "_xludf.NEGBINOM.DIST",
    "NORM.DIST":        "_xludf.NORM.DIST",
    "NORM.INV":         "_xludf.NORM.INV",
    "NORM.S.DIST":      "_xludf.NORM.S.DIST",
    "NORM.S.INV":       "_xlfn.NORM.S.INV",  # confirmed _xlfn in workbook.xml
    "PERCENTILE.EXC":   "_xludf.PERCENTILE.EXC",
    "PERCENTILE.INC":   "_xludf.PERCENTILE.INC",
    "PERCENTRANK.EXC":  "_xludf.PERCENTRANK.EXC",
    "PERCENTRANK.INC":  "_xludf.PERCENTRANK.INC",
    "POISSON.DIST":     "_xludf.POISSON.DIST",
    "QUARTILE.EXC":     "_xludf.QUARTILE.EXC",
    "QUARTILE.INC":     "_xludf.QUARTILE.INC",
    "RANK.AVG":         "_xlfn.RANK.AVG",    # confirmed _xlfn in workbook.xml
    "RANK.EQ":          "_xludf.RANK.EQ",
    "STDEV.P":          "_xludf.STDEV.P",
    "STDEV.S":          "_xludf.STDEV.S",
    "T.DIST":           "_xludf.T.DIST",
    "T.DIST.2T":        "_xlfn.T.DIST.2T",  # confirmed _xlfn in workbook.xml
    "T.DIST.RT":        "_xludf.T.DIST.RT",
    "T.INV":            "_xludf.T.INV",
    "T.INV.2T":         "_xlfn.T.INV.2T",   # confirmed _xlfn in workbook.xml
    "T.TEST":           "_xludf.T.TEST",
    "VAR.P":            "_xludf.VAR.P",
    "VAR.S":            "_xludf.VAR.S",
    "WEIBULL.DIST":     "_xludf.WEIBULL.DIST",
    "Z.TEST":           "_xludf.Z.TEST",
