"""
format_workbook.py
Visual formatting for Lambda_Library.xlsx.
Not wired up yet — call format_workbook(path) after build_workbook.py when ready.
...
def format_workbook(path: str) -> None:
    """
    Open an existing Lambda_Library.xlsx and apply all visual formatting.
