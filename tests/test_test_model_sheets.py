...
def test_row_constants_match_the_writers_own_layout() -> None:
    ...
    # v3.4 relabelled AG8 from "RMSE (Unit)" to "SE Regression (Unit)": the
    ...
    # smearing optimism actually touches, plus the named treatment at AH13.
    assert unit_space[10] == "CROSS-VALIDATED FIT"
