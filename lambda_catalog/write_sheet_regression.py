...
def write_regression_output_sheet(
    ...
    sheet_notes : dict[str, str] | None
        Mapping of sheet label → plain-language note text, loaded from the
        ``regression_sheet_notes`` key in lambda_functions.json. Pass ``None``
        (or omit) to skip annotation — useful for isolated sheet tests.
    """
