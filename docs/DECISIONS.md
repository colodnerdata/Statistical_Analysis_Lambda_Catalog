...
2. **A 205-column design cannot be fitted, so G14 is a guard state.** At
...
**The regression that guards it (G14 / G15).** Every existing test-model case
...
`GuardStateCase.shell_profile_key` creates the disagreement deliberately: G15
